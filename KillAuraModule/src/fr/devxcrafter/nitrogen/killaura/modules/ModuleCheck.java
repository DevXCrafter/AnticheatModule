...
import fr.devxcrafter.nitrogen.killaura.KillAuraMain;

public abstract class ModuleCheck implements Listener {
	
	protected String name;
	protected ModulesType type;
	...
	public ModuleCheck(String name, ModulesType type, boolean enabled, boolean punishable, int max) {
		super();
		this.name = name;
		this.type = type;
		...
		Bukkit.getPluginManager().registerEvents(this, KillAuraMain.getInstance());
	}
