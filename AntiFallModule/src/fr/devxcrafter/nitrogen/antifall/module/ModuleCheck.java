...
import fr.devxcrafter.nitrogen.antifall.AntiFallMain;
...
public abstract class ModuleCheck implements Listener {
	...
	public ModuleCheck(String name, ModuleType type, boolean enabled, boolean punishable, int max) {
		super();
		this.name = name;
		this.type = type;
		...
		Bukkit.getPluginManager().registerEvents(this, AntiFallMain.getInstance());
	}
